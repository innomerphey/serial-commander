  ...
  async send(command, {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.serialDataHandler = line => {
        ...
        const isCommandSuccessfullyTerminated = expectedResponses.some(expectedResponse => exactMatch ? normalizedLine === expectedResponse : line.includes(expectedResponse));
